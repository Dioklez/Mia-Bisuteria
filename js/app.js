...
const PRODUCTOS_DEFAULT = [
  {id:0,  nombre:'Anillo de Flores Rosa',           precio:2500,  tipo:'anillo',    col:'flores',    desc:'Hecho a mano con mostacillas checas y componentes gold filled.',imgs:['https://miabisuteria.com/images/anillo-flores-rosa.jpeg']},
  {id:1,  nombre:'Anillo de Flores Blanco',         precio:2500,  tipo:'anillo',    col:'flores',    desc:'Hecho a mano con mostacillas checas y componentes gold filled.',imgs:['https://miabisuteria.com/images/anillo-flores-blanco.jpeg']},
  {id:2,  nombre:'Argollas Alas en Flor',           precio:11999, tipo:'argolla',   col:'mariposa',  desc:'Base de aro gold filled con dijes de flores hechos a mano.',imgs:['https://miabisuteria.com/images/argollas-alas-flor-1.jpeg','images/argollas-alas-flor-2.jpeg','images/argollas-alas-flor-3.jpeg']},
  {id:3,  nombre:'Argollas Alma de Girasoles',      precio:11999, tipo:'argolla',   col:'girasol',   desc:'Base de aro gold filled con dijes de flores hechos a mano.',imgs:['https://miabisuteria.com/images/argollas-alma-girasol-1.jpeg','images/argollas-alma-girasol-2.jpeg']},
  {id:4,  nombre:'Argollas Lluvia de Margaritas',   precio:13900, tipo:'argolla',   col:'flores',    desc:'Base de aro gold filled con dijes de flores hechos a mano.',imgs:['https://miabisuteria.com/images/argollas-lluvia-margaritas.jpeg']},
  {id:5,  nombre:'Argollas Flor de Nieve',          precio:9900,  tipo:'argolla',   col:'flores',    desc:'Base de aro gold filled con dijes de flores hechos a mano.',imgs:['https://miabisuteria.com/images/argollas-flor-nieve.jpeg']},
  {id:6,  nombre:'Collar Mariposa Lila',            precio:10500, tipo:'collar',    col:'mariposa',  desc:'Hecho a mano con mostacillas Miyuki, cristal de roca y componentes gold filled. Fino, femenino y muy liviano.',imgs:['https://miabisuteria.com/images/collar-mariposa-lila-1.jpeg','images/collar-mariposa-lila-2.jpeg']},
  {id:7,  nombre:'Gargantilla Lluvia de Margaritas',precio:13490, tipo:'collar',    col:'flores',    desc:'Diseño delicado con mostacillas y componentes gold filled. 37 cm de largo con 5 cm de extensión.',imgs:['https://miabisuteria.com/images/gargantilla-lluvia-margaritas-1.jpeg','images/gargantilla-lluvia-margaritas-2.jpeg','images/gargantilla-lluvia-margaritas-3.jpeg','images/gargantilla-lluvia-margaritas-4.jpeg']},
  {id:8,  nombre:'Tobillera de Caracoles',          precio:4000,  tipo:'tobillera', col:'caracoles', desc:'El accesorio que vuelve todos los veranos. Caracoles naturales, detalles en Miyuki, gold filled y cierre regulable.',imgs:['https://miabisuteria.com/images/tobillera-caracoles-1.jpeg','images/tobillera-caracoles-2.jpeg','images/tobillera-caracoles-3.jpeg','images/tobillera-caracoles-4.jpeg']},
  {id:9,  nombre:'Pulsera Alma de Girasoles',       precio:6499,  tipo:'pulsera',   col:'girasol',   desc:'Hecha a mano con mostacillas checas, cristales checos y componentes gold filled.',imgs:['https://miabisuteria.com/images/pulsera-alma-girasol-1.jpeg','images/pulsera-alma-girasol-2.jpeg','images/pulsera-alma-girasol-3.jpeg']},
  {id:10, nombre:'Pulsera Flor de Nieve',           precio:8700,  tipo:'pulsera',   col:'flores',    desc:'Diseño delicado con mostacillas y componentes gold filled. 16 cm de largo con 5 cm de extensión.',imgs:['https://miabisuteria.com/images/pulsera-flor-nieve.jpeg']},
  {id:11, nombre:'Pulsera Margaritas de Amor Rosa', precio:8800,  tipo:'pulsera',   col:'flores',    desc:'Diseño delicado con mostacillas, cristales y componentes gold filled. 16 cm de largo con 5 cm de extensión.',imgs:['https://miabisuteria.com/images/margaritas-amor-rosa-1.jpeg','images/margaritas-amor-rosa-2.jpeg']},
  {id:12, nombre:'Pulsera Patria de Flores',        precio:9900,  tipo:'pulsera',   col:'flores',    desc:'Un accesorio que representa identidad, amor y raíces. Mostacillas, cristales y gold filled. 16 cm con 5 cm de extensión.',imgs:['https://miabisuteria.com/images/pulsera-patria-flores-1.jpeg','images/pulsera-patria-flores-2.jpeg','images/pulsera-patria-flores-3.jpeg']},
  {id:13, nombre:'Pulsera Flor Amapola Rosa',       precio:9500,  tipo:'pulsera',   col:'flores',    desc:'Diseño delicado con mostacillas, cristales y componentes gold filled. 16 cm de largo con 5 cm de extensión.',imgs:['https://miabisuteria.com/images/pulsera-flor-amapola-rosa-1.jpeg','images/pulsera-flor-amapola-rosa-2.jpeg']},
  {id:14, nombre:'Pulsera Tierra Floral',           precio:8700,  tipo:'pulsera',   col:'flores',    desc:'Diseño delicado con mostacillas, cristales y componentes gold filled. 16 cm de largo con 5 cm de extensión.',imgs:['https://miabisuteria.com/images/pulsera-tierra-flor-1.jpeg','images/pulsera-tierra-flor-2.jpeg']},
  {id:15, nombre:'Pulsera Margaritas',              precio:9000,  tipo:'pulsera',   col:'flores',    desc:'Hecha a mano con Miyuki rocalla 8/0 y componentes gold filled. 16 cm de largo con 5 cm de extensión.',imgs:['https://miabisuteria.com/images/pulsera-margaritas-1.jpeg','images/pulsera-margaritas-2.jpeg']},
  {id:16, nombre:'Pulsera Cherry con Margaritas',   precio:8650,  tipo:'pulsera',   col:'cherry',    desc:'Diseño delicado con mostacillas, cristales y componentes gold filled. 16 cm de largo con 5 cm de extensión.',imgs:['https://miabisuteria.com/images/pulsera-cherry-margaritas-1.jpeg','images/pulsera-cherry-margaritas-2.jpeg']},
  {id:17, nombre:'Pulsera Mariposa Mía',            precio:8500,  tipo:'pulsera',   col:'mariposa',  desc:'Hecha a mano con Miyuki, cristal de roca y componentes gold filled. 16 cm de largo con 5 cm de extensión.',imgs:['https://miabisuteria.com/images/pulsera-mariposa-mia.jpeg']},
  {id:18, nombre:'Pulsera Suspiro Lila',            precio:8500,  tipo:'pulsera',   col:'flores',    desc:'Hecha a mano con mostacillas, cristales y componentes gold filled.',imgs:['https://miabisuteria.com/images/pulsera-suspiro-lila.jpeg']},
  {id:19, nombre:'Daisy Bracelet con Cristales',    precio:6900,  tipo:'pulsera',   col:'flores',    desc:'Hecha a mano con Miyuki, cristal de roca y componentes gold filled. 16 cm de largo con 5 cm de extensión.',imgs:['https://miabisuteria.com/images/daisy-bracelet-cristales-1.jpeg','images/daisy-bracelet-cristales-2.jpeg','images/daisy-bracelet-cristales-3.jpeg']},
  {id:20, nombre:'Pulsera Rapunzel',                precio:6900,  tipo:'pulsera',   col:'flores',    desc:'Hecha a mano con Miyuki, cristal de roca, mostacillas checas y componentes gold filled. 16 cm con 5 cm de extensión.',imgs:['https://miabisuteria.com/images/pulsera-rapunzel.jpeg']},
  {id:21, nombre:'Pulsera Miel',                    precio:6900,  tipo:'pulsera',   col:'flores',    desc:'Hecha a mano con Miyuki, cristal de roca y componentes gold filled. 16 cm de largo con 5 cm de extensión.',imgs:['https://miabisuteria.com/images/pulsera-miel-1.jpeg','images/pulsera-miel-2.jpeg']},
  {id:22, nombre:'Pulsera Petalina',                precio:6900,  tipo:'pulsera',   col:'flores',    desc:'Inspirada en los pétalos más suaves del jardín. Hecha a mano con mostacillas, cristales y componentes gold filled.',imgs:['https://miabisuteria.com/images/pulsera-petalina.jpeg']},
  {id:23, nombre:'Aros Flor de Cristal',            precio:10700, tipo:'argolla',   col:'flores',    desc:'Base de aro gold filled y flores hechas a mano.',imgs:['https://miabisuteria.com/images/aros-flor-cristal.jpeg']},
  {id:24, nombre:'Pulsera Suspiro de Primavera',    precio:7200,  tipo:'pulsera',   col:'flores',    desc:'Hecha a mano con Miyuki y componentes gold filled. 16 cm de largo con 5 cm de extensión.',imgs:['https://miabisuteria.com/images/pulsera-suspiro-primavera.jpeg']},
  {id:25, nombre:'Aros Flor de Cristal Lila',       precio:10700, tipo:'argolla',   col:'flores',    desc:'Base de aro gold filled y flores hechas a mano.',imgs:['https://miabisuteria.com/images/aros-flor-cristal-lila.jpeg']},
];
...
window.irAlPaso = window.irAlPago = async function() {
  ...
  try {
    ...
    const mp = new MercadoPago('APP_USR-c32fed7f-33b6-44b2-95f2-16f9459af1ef', { locale: 'es-AR' });
